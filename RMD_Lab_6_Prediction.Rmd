...
* $f_s(x)=f(x|Y=y_s)$ <- funzione di densità dei predittori lineari per la cat. s
* $\pi_s = P(T=y_s)$ <- prob. marginale per la cat. s


(per la categoria s, posso computare un certo val stimato usando un mod. lineare costruito su X)
...
* media <- stimo con media delle oss. $x_i$ appartenenti alla classe $y_s$
