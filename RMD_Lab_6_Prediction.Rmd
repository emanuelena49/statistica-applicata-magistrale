...
Stima della prob. che si verifichi un tipo di oss. piuttosto che un altro
...
Si posso effettuare previsioni e confrontarle con i val. osservati => posso calcolare un tasso d'errore
...
=> ci poniamo l'obiettivo di minimizzarla 
...
Nella realtà non conosco queste probabilità. 

Potrei stimarle con regr. logistca
