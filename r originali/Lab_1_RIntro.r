...
# This is because R sees "\" as an escape character. Instead, use c:/mydocuments/myfile.txt   # use the back slash
...
# dat <- read.table("file.cvs", sep=",", header=T) # to read data from a text file with sep="," (the default for read.table) as field separator
